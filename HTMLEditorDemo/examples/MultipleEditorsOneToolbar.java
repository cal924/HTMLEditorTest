...
public class MultipleEditorsOneToolbar extends javax.swing.JFrame implements FocusListener{
    ...
    public MultipleEditorsOneToolbar() {
        initComponents();
        setSize(800,600);
        htmlEditor1=new sferyx.administration.editors.HTMLEditor(false,false,true,false,false,true);
        htmlEditor2=new sferyx.administration.editors.HTMLEditor(false,false,true,false,false,true);
        ...
        JPanel fontToolbarHolder=new JPanel();
        fontToolbarHolder.setLayout(new BorderLayout());
        fontToolbarHolder.add(htmlEditor1.getEditingToolBar(),"West");
        
        JPanel shortcutsToolbarHolder=new JPanel();
        shortcutsToolbarHolder.setLayout(new BorderLayout());
        shortcutsToolbarHolder.add(htmlEditor1.getFormattingToolBar(),"West");
        
        toolbarPanel.add(fontToolbarHolder);
        toolbarPanel.add(shortcutsToolbarHolder);    
    ...
    public void focusGained(java.awt.event.FocusEvent focusEvent) {
      ...
      sferyx.administration.editors.HTMLEditor activeHTMLEditor;
    
    public void switchToolbars()
    {
        
            activeHTMLEditor=htmlEditor1.getActiveHTMLEditor();
            ...
            JPanel fontToolbarHolder=new JPanel();
            fontToolbarHolder.setLayout(new BorderLayout());
            fontToolbarHolder.add(activeHTMLEditor.getEditingToolBar(),"West");
        
            JPanel shortcutsToolbarHolder=new JPanel();
            shortcutsToolbarHolder.setLayout(new BorderLayout());
            shortcutsToolbarHolder.add(activeHTMLEditor.getFormattingToolBar(),"West");
